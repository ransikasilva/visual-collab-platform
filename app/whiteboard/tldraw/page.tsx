  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, position: 'relative', overflow: 'hidden' }}>
        <ErrorBoundary>
          <Tldraw
            licenseKey="tldraw-2026-03-21/WyJBVzhvV3lHdiIsWyIqIl0sMTYsIjIwMjYtMDMtMjEiXQ.DTIKPdBedP0TGMaUkx2qQKUxrgb7tPTTNcbjdKuoYOBeWVNcZ6aImCryRrQMnZiPPxykTtn7VBEVKvr41MEc+g"
            onUiEvent={(name, data) => {
